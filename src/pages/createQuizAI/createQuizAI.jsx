...
const CreateQuizAI = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/create', newQuiz, {
                headers: {
        ...
        try {
            const response = await axios.post(
                `https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/image/${quizId}`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
