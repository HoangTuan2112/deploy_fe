...
const QuizDetail = () => {
    ...
    useEffect(() => {
        const fetchQuizData = async () => {
            try {
                const response = await axios.get(`https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/${id}`, {
                    headers: {
                    ...
                    <Row justify="center">
                        <Col style={{ padding: "1.25rem!important" }}>
                            <div style={{
                                ...
                                <Row style={{ gap: "1rem" }}>
                                    <Col span={8}>
                                        <Image src='http://upload-api.eduquiz.io.vn/default/exam/exam-02.png' preview={false}></Image>
                                    </Col>
