...
const ReportQuizResult = () => {
    ...
    useEffect(() => {
        const fetchThiThuData = async () => {
            try {
                const response = await axios.get('https://kltn-0bb604b830af.herokuapp.com/api/v1/result/user', {
                    headers: {
        ...
        const fetchCompetitionData = async () => {
            try {
                const response = await axios.get('https://kltn-0bb604b830af.herokuapp.com/api/v1/result/competition/user', {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('token')}`,
                        'Content-Type': 'application/json',
                        'Accept': '*/*'
