...
const UserCompetitions = () => {
    ...
    useEffect(() => {
        const fetchCompetitions = async () => {
            try {
                const response = await axios.get('https://kltn-0bb604b830af.herokuapp.com/api/v1/competitions/user', {
                    headers: {
    ...
    const handleDeleteCompetition = async () => {
        try {
            await axios.delete(`https://kltn-0bb604b830af.herokuapp.com/api/v1/competitions/delete/${selectedCompetitionId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
