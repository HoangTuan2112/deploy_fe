...
const QuizList = () => {
    ...
    useEffect(() => {
        const fetchQuizzes = async () => {
            try {
                const response = await axios.get('https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/user', {
                    headers: {
    ...
    useEffect(() => {
        const fetchFavorQuizzes = async () => {
            try {
                const response = await axios.get('https://kltn-0bb604b830af.herokuapp.com/api/v1/users/me', {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
                        'Accept': '*/*'
    ...
    const handleDeleteQuiz = async (quizId) => {
        try {
            const response = await axios.delete(`https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/${quizId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                    'Accept': '*/*'
    ...
    const toggleFavorite = async (quizId) => {
        try {
            if (favorquizzes.includes(quizId)) {
                const res = await axios.delete(`https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/unfavorite/${quizId}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
                    }
                ...
                const res = await axios.post(`https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/favorite/${quizId}`, {}, {
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
                    }
    ...
    const togglePublish = async (quizId) => {
        try {
            const url = publishedQuizzes.includes(quizId)
                ? `https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/unpublish/${quizId}`
                : `https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/publish/${quizId}`;
