...
const UpdateCompetition = () => {
    ...
    useEffect(() => {
        const fetchCompetitionData = async () => {
            try {
                const res = await axios.get(`https://kltn-0bb604b830af.herokuapp.com/api/v1/competitions/getById/${competitionId}`, {
                    headers: {
    ...
    const onFinish = async (values) => {
        ...
        try {
            const response = await axios.put(`https://kltn-0bb604b830af.herokuapp.com/api/v1/competitions/update/${competitionId}`, payload, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
