...
const QuizExam = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('https://kltn-0bb604b830af.herokuapp.com/api/v1/quizs/submit', quizResult, {
                headers: {
                        ...
                        <Card title={storedQuiz?.title} bordered={false} style={{ width: 300, boxShadow: "0px 4px 12px rgba(0, 0, 0, 0.1)", borderRadius: "8px" }}>
                            ...
                            >
                                <div style={{ maxWidth: "300px", marginLeft: "auto", marginRight: "auto" }}>
                                    <Image src='http://studio.eduquiz.vn/assets/images/exam/img_hoanthanh@2x.png' preview={false} />
                                </div>
