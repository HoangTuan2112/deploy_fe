...
const VerifyAccount = () => {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://kltn-0bb604b830af.herokuapp.com/api/v1/users/verify', dataCode);
  ...
  const handleResendCode = async () => {
    try {
      setResending(true);
      const res = await axios.post(`https://kltn-0bb604b830af.herokuapp.com/api/v1/users/resend-verification/${email}`);
