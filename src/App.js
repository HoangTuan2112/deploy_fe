...
const App = () => {
    ...
    const handleJoin = () => {
        ...
        const fetchCompetitionData = async () => {
            try {
                const response = await axios.get(`https://kltn-0bb604b830af.herokuapp.com/api/v1/competitions/getByCode/${code}`, {
                    headers: {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`https://kltn-0bb604b830af.herokuapp.com/api/v1/tokens/${token}`);
            ...
            <Layout>
                ...
                >
                    <div style={{ textAlign: "center", marginBottom: "20px" }}>
                        <Link to='/'>
                            <Image
                                src="http://cf.quizizz.com/img/logos/Purple.webp"
                                preview={false}
                        ...
                        <div style={{ display: "flex", justifyContent: "center", gap: "20px", }}>
                            <Card
                                ...
                                cover={
                                    <img
                                        alt="example"
                                        src="http://templatelab.com/wp-content/uploads/2017/04/puzzle-piece-template-13.jpg"
                                    />
                                }
                            >
                            ...
                            <Card
                                ...
                                cover={
                                    <img
                                        alt="example"
                                        src="http://quizizz.com/media/resource/gs/quizizz-media/quizzes/1c22eeb6-0b9d-446e-aa03-9c21f3cb3c65?w=400&h=400"
                                    />
                                }
                            >
